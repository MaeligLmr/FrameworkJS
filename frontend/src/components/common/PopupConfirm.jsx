    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/50">
      <div className="bg-white relative rounded-lg p-6 max-w-sm mx-auto">
        ...
        <div className="flex justify-end">
          ...
          <button onClick={onConfirm} className={"px-4 py-2 text-white rounded-lg" + (confirmText == "Supprimer" ? "bg-red-600 hover:bg-red-700" : "bg-blue-600 hover:bg-blue-700")}>{confirmText}</button>
        </div>
      </div>
    </div>
  );
